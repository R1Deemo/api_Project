...
const { add_article_schema, get_articleList_schema, edit_article_schema } = require('../schema/article')
...
//根据id更新文章信息
router.post('/edit', upload.single('cover_img'), expressJoi(edit_article_schema), articl_handler.editArticle)
